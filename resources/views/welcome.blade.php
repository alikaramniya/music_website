                ...
                <div class="jp-type-playlist">
                    <div class="jp-gui jp-interface">
                        <div class="jp-volume-controls">
                            ...
                            <div style="direction: ltr;" class="jp-volume-bar">
                        ...
                        <div class="jp-controls-holder">
                            ...
                            <div class="jp-progress">
                                <div style="direction: ltr;" class="jp-seek-bar">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="package wow fadeInLeft animated" data-wow-offset="250" data-wow-delay="200ms">
                    ...
                    <strong class="price"><small>{{ $album->price }}</small>تومان</strong>
                </div><!-- end package -->
            </div><!-- end col-md-6 -->
            @else
            <div class="col-md-6">
...
<section id="teams" class="section teams">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div id="programmer" class="person"><img src="/images/index.png" alt="" class="img-responsive">
                    <div class="person-content">
                        <h4>admin</h4>
                        <p style="font-size:15px;">خوش حالم که زحمت های من مفید واقع شده و تونستم که سایتی متناسب با نیاز شما کاربران عزیز تهیه کرده باشم</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="map-row" class="row">
            <div class="col-xs-12">
                ...
                <div id="map-overlay" class="col-xs-5 col-xs-offset-6" style="">
                    ...
                    ©تمام حقوق مادی و معنوی این سایت مطلق به سایت TUNES می باشد و هرگونه کپی برداری خلاف قانون و پیگرد قانونی داد.
                </div>
            </div>
        </div>
    </div>
