...
class AnswerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->only([
            'user_id', 'comment_id', 'type', 'description'
        ]);
        Answer::create($data);
    ...
    {
        return view('admin.answer.updateOldAnswer', compact('answer'));
    }
    ...
    public function deleteAnsewrAndUpdateCommentAnswer(Answer $answer, $comment)
    {
